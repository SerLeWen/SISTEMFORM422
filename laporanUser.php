...
<head>
  ...
  <title>SISTEM AuDio Carian</title>
          ...
          <div class="col-12">
            <div class="card card-primary">
              ...
              ?>
                ...
                <form action="laporanhasilUser.php">
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                        ...
                        <div class="form-group">
                            <div class="input-group input-group-lg">
                                <input type="search" class="form-control" placeholder="Isikan Produk carian anda disini" name="f_namaproduk" value='%'>
